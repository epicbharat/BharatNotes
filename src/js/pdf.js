...
(function () {
  ...
  function buildTopicHTML(qrData) {
    ...
    var css = [
      ...
      ".ct h2[data-pdf-type='upsc']::before { content:'\\A7\\A0\\A0'; font-size:9.5pt; }",
      ".ct h2[data-pdf-type='pyq'] { color:#1a1a1a; border-bottom:1.5px solid #1a1a1a; }",
      ".ct h2[data-pdf-type='pyq']::before { content:'\\2022\\A0\\A0'; font-size:9.5pt; }",
      ...
      ".ct h2[data-pdf-type='vocab']::before { content:'\\203A\\A0\\A0'; font-size:9.5pt; }",
      ".ct h2[data-pdf-type='terms'] { color:#1a1a1a; border-bottom:1.5px solid #1a1a1a; }",
      ".ct h2[data-pdf-type='terms']::before { content:'\\BB\\A0\\A0'; font-size:9.5pt; }",
