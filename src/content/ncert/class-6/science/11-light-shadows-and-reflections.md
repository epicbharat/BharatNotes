...
description: "Transparent, translucent, opaque materials; shadow formation; rectilinear propagation of light; reflection; pinhole camera — Class VI Science Ch11."
ncert_class: 6
book: "Science"
book_slug: science
chapter: 11
...
1. During a total lunar eclipse, the Moon appears reddish because:<br>
   (a) The Moon absorbs blue light<br>
   (b) Dust on the Moon reflects red light<br>
   **(c) Earth's atmosphere refracts red wavelengths of sunlight onto the Moon**<br>
   (d) The Moon enters the Sun's shadow

2. A solar eclipse occurs when:<br>
   **(a) The Moon comes between the Earth and the Sun**<br>
   (b) The Earth comes between the Sun and the Moon<br>
   (c) The Sun comes between the Earth and the Moon<br>
   (d) The Moon's orbit intersects Earth's orbit

3. The image formed in a pinhole camera is:<br>
   (a) Upright and virtual<br>
   **(b) Inverted and real**<br>
   (c) Upright and real<br>
