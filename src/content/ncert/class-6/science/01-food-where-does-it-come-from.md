...
description: "Sources of food — plants and animals, herbivores, omnivores, carnivores, ingredients and their origins, food diversity across India — Class VI Science Ch1 enriched for UPSC GS3."
ncert_class: 6
book: "Science"
book_slug: science
chapter: 1
...
India's food culture is extraordinarily diverse — shaped by geography, climate, religion, and tradition:
...
1. Which of the following is a modified stem used as food?<br>
   (a) Carrot<br>
   (b) Radish<br>
   **(c) Potato**<br>
   (d) Beetroot

2. India's White Revolution (Operation Flood) is associated with:<br>
   (a) Sugar production<br>
