...
title: "Air Around Us"
description: "Composition of air, properties, importance of air for life, wind, air pollution — Class VI Science Ch15 enriched for UPSC GS3 environment and pollution."
ncert_class: 6
book: "Science"
book_slug: science
chapter: 15
...
::: ncert-box--explainer
**Nitrogen cycle:**
Atmosphere is 78% nitrogen but most organisms cannot use N₂ directly. Nitrogen must be "fixed" (converted to usable forms):
...
1. The largest component of air by volume is:<br>
   (a) Oxygen<br>
   **(b) Nitrogen**<br>
   (c) Carbon dioxide<br>
   (d) Argon

2. PM2.5 refers to particulate matter with diameter less than:<br>
   (a) 10 micrometres<br>
   **(b) 2.5 micrometres**<br>
   (c) 1 micrometre<br>
   (d) 25 micrometres

3. The National Clean Air Programme (NCAP) was launched in:<br>
   (a) 2014<br>
   (b) 2016<br>
   **(c) 2019**<br>
   (d) 2022

4. Rhizobium bacteria, which fix atmospheric nitrogen, are found in:<br>
   (a) Soil around all plants<br>
   **(b) Root nodules of leguminous plants**<br>
   (c) Leaf surfaces<br>
   (d) Water bodies

**Mains:**

5. Air pollution has emerged as India's largest environmental health crisis. Critically examine the causes and evaluate the effectiveness of India's policy response. (GS3, 15 marks)
