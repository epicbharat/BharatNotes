---
layout: topic.njk
title: "Agriculture's Environmental Footprint — Climate, Soil & Water Nexus"
subject: environment
parent_topic: "Ecology & Environment"
...
1. **UPSC Prelims 2019:** With reference to India's agriculture, which of the following statements is/are correct regarding the Soil Health Card Scheme?
   *(Tests: launch year, parameters tested, implementing agency)*

2. **UPSC Prelims 2021:** Consider the following statements regarding methane emissions from agriculture:
   1. Enteric fermentation in ruminants is the largest single source of agricultural methane globally.
   2. Alternate Wetting and Drying (AWD) is a technique used to reduce methane from paddy fields.
   Which of the statements given above is/are correct? *(Answer: Both 1 and 2)*

3. **UPSC Prelims 2022:** With reference to 'Zero Budget Natural Farming (ZBNF)', which of the following is/are correct?
   1. It was developed by Subhash Palekar.
   2. Andhra Pradesh was the first state to adopt it as a state-level programme.
   *(Answer: Both correct)*

4. **UPSC Prelims 2023:** The term 'eutrophication' refers to which of the following?
   (a) Depletion of oxygen in water bodies due to excess nutrient runoff
   (b) Acidification of soil by nitrogen deposition
   (c) Bioaccumulation of heavy metals in aquatic organisms
   (d) Loss of biodiversity due to monoculture farming
   *(Answer: a)*

### Mains

1. **UPSC Mains GS3 2018:** What are the challenges of stubble burning in India? Suggest measures to control it. *(200 words)*

2. **UPSC Mains GS3 2020:** Discuss the contribution of the agriculture sector to India's greenhouse gas emissions. What measures can be taken to make Indian agriculture climate-resilient while reducing its carbon footprint? *(250 words)*

3. **UPSC Mains GS3 2022:** "The Green Revolution solved India's food crisis but created an environmental crisis." Critically examine with reference to Punjab's groundwater depletion and soil health degradation. *(250 words)*

4. **UPSC Mains GS3 2023:** Evaluate the role of Zero Budget Natural Farming (ZBNF) and organic farming initiatives in reducing agriculture's environmental impact. What are the challenges in scaling these approaches across India? *(250 words)*
