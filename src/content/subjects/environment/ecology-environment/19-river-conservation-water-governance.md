---
layout: topic.njk
title: "River Conservation & Water Governance — Namami Gange, Interlinking & Water Policy"
subject: environment
gs_papers:
  - gs3
...
*Sources: PIB (pib.gov.in), NMCG (nmcg.nic.in), CPCB (cpcb.nic.in), CGWB (cgwb.gov.in), Jal Jeevan Mission (jaljeevanmission.gov.in), NITI Aayog (niti.gov.in), CWC (cwc.gov.in). For current affairs on water policy and environmental governance updates, visit [Ujiyari.com](https://ujiyari.com).*
