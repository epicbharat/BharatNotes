---
layout: topic.njk
title: "Cryosphere, Himalayan Glaciers & Polar Regions — Climate & Security Implications"
subject: environment
...
1. **Albedo feedback** — as sea ice retreats, dark ocean absorbs more heat instead of reflecting it
2. **Ice-albedo feedback amplification** — the warming accelerates further ice loss
3. **Lapse rate feedback** — in the Arctic, surface warming is not distributed through the atmosphere as efficiently as in the tropics
4. **Water vapour and cloud feedbacks** — increased moisture amplifies warming
...
Headquartered in **Vasco da Gama, Goa**, NCPOR is the nodal agency for all Indian polar research (Arctic, Antarctic, and Southern Ocean). It plans and coordinates annual scientific expeditions.
...
- For current affairs integration on recent GLOF events, refer to [Ujiyari.com](https://ujiyari.com)
