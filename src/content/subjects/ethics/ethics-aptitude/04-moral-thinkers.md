---
layout: topic.njk
title: "Contributions of Moral Thinkers & Philosophers — Western & Indian Ethical Thought"
subject: ethics
...
- **UPSC Relevance:** GS4 Ethics — one of the most frequently tested Western thinkers. The Categorical Imperative (universalisability test + humanity formula) appears in both theory questions and case studies. In Section B, apply Kant to test whether a proposed action can be universalised and whether it treats all stakeholders as ends. Cite alongside Rawls and Gandhi for a multi-framework approach.
...
- **UPSC Relevance:** GS4 Ethics — essential for social justice, reservation, and welfare policy questions. The Veil of Ignorance is a powerful thought experiment for case studies involving equitable resource allocation. The Difference Principle justifies affirmative action in answers on reservation policy. Also relevant for GS2 (social justice) and Essay paper themes on inequality and fairness.
