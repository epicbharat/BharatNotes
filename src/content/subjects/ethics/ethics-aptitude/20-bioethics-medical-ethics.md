...
description: "Comprehensive UPSC GS4 notes on Bioethics and Medical Ethics — covering the four pillars, euthanasia, surrogacy laws, organ donation, informed consent, clinical trial ethics, and genetic technology debates."
sub_chapter: 20
date: 2026-03-29
foundation: true
prelims: false
...
1. **Identifying the ethical conflict** — typically between two or more of the four principles (e.g., autonomy vs beneficence in refusing treatment)
2. **Citing Indian legal landmarks** — Aruna Shanbaug (2011), Common Cause (2018), Samira Kohli (2008) add authority to your answer
3. **Linking to constitutional rights** — Article 21 (right to life with dignity), right to health as an implied right
4. **Offering a balanced view** — acknowledge tensions without giving a simplistic answer
