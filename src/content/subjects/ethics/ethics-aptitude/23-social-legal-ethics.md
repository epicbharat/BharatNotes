---
layout: topic.njk
title: "Social & Legal Ethics — Child Labour, Juvenile Justice, Animal Rights, Capital Punishment, Affirmative Action & Whistleblowing"
subject: ethics
...
description: "UPSC GS4 notes on social and legal ethics — child labour laws and ethical tensions, juvenile justice and trying minors as adults, animal ethics (Singer, Regan, 3Rs), capital punishment and the rarest of rare doctrine, ethics of affirmative action, and whistleblowing morality."
sub_chapter: 23
date: 2026-03-29
foundation: true
prelims: false
...
1. JJB conducts a **preliminary assessment** (not a trial) of the child's mental and physical capacity to commit the offence and understand its consequences.
2. JJB may transfer the case to the **Children's Court** (Sessions Court) for trial as an adult.
3. Even if convicted as an adult, the child is sent to a **place of safety** (not an adult jail) until age 21, after which the Children's Court reviews whether to transfer to an adult prison or release.
...
1. Is there something uncommon about the crime that renders imprisonment for life inadequate?
2. Are the circumstances such that there is no alternative but to impose death even after giving maximum weightage to mitigating factors?
...
1. **Ethical framework application** — do not just describe the law; apply utilitarian, rights-based, and virtue ethics lenses to each issue.
2. **Balanced analysis** — present both sides before giving a reasoned conclusion; UPSC rewards nuance over dogmatism.
3. **Case study readiness** — Satyendra Dubey, Jallikattu, Nirbhaya, Bachan Singh are case study fodder; know facts and ethical dimensions.
