---
layout: topic.njk
title: "Oceanography — Ocean Currents, Tides & Marine Geography"
subject: geography
...
The Indian Ocean is unique because it is **partly landlocked** in the north — bounded by the Asian continent. This causes seasonal reversal of currents under the influence of the monsoon.
...
Tides are the **periodic rise and fall of sea levels** caused by the **gravitational forces of the Moon and Sun**, combined with Earth's rotation.
...
- India has significant tidal energy potential especially in the **Gulf of Khambhat (Cambay)** and the **Gulf of Kutch**.
- Tidal energy is predictable and reliable — unlike wind or solar.
- High installation costs are the main barrier; globally, France's La Rance tidal barrage (240 MW) is the largest conventional tidal power plant.
...
- **Potato-sized lumps** found on the abyssal plains at 4,000–6,000 m depth.
- Composition: Manganese, nickel, cobalt, copper, iron, and trace elements.
- **Central Indian Ocean Basin (CIOB):** India has an **exclusive exploration area of 75,000 sq. km** in the CIOB, allocated by the International Seabed Authority (ISA).
- India was one of the **first registered pioneer investors** with the ISA following UNCLOS adoption.
- Estimated **380 million metric tonnes** of polymetallic nodules in India's exploration area — worth approximately $110 billion.

### Hydrothermal Vents and Multi-metal Sulphides

- Hydrothermal vents form at mid-oceanic ridges; superheated water rich in dissolved minerals gushes out, forming **chimney-like deposits** of metal sulphides.
...
- Found on the slopes of seamounts and ridges at 800–2,500 m depth.
- Rich in cobalt (critical for EV batteries), nickel, platinum, and rare earth elements.
- Less explored than polymetallic nodules.

### India's Deep Ocean Mission

- **Approved:** June 2021 by Union Cabinet.
- **Lead agency:** Ministry of Earth Sciences (MoES).
- **Budget:** ₹4,077 crore for 5 years (2021–2026); first phase (2021–24) allocated ₹2,823 crore.
- **Six components:**
  ...
  3. Technological innovation for Sustainable Harnessing of Ocean Bio-resources.
  4. Deep Ocean Survey and Exploration.
  5. Energy and Fresh Water from the Ocean.
  6. Advanced Marine Station for Ocean Biology.
- **Manned submersible:** India is developing **"Matsya-6000"** — capable of carrying 3 people to a depth of **6,000 metres** with a 12-hour endurance (plus 96-hour emergency power).

---

## UNCLOS 1982 — Maritime Zones

### Background

- **United Nations Convention on the Law of the Sea (UNCLOS)** was adopted in **1982** at Montego Bay, Jamaica; entered into force **November 16, 1994**.
...
- India's EEZ covers approximately **2.37 million sq. km** — one of the largest in the world.
- India is pursuing **extended continental shelf (ECS)** rights beyond 200 nm under Article 76 of UNCLOS; claim submitted to the Commission on the Limits of the Continental Shelf (CLCS).

### International Seabed Authority (ISA)

- Established by UNCLOS to regulate exploration and exploitation of mineral resources in "the Area" (beyond 200 nm).
- Based in Kingston, Jamaica.
- India has a 75,000 sq. km exclusive exploration area in the Central Indian Ocean Basin for polymetallic nodules; additionally, India has an exploration contract for **polymetallic sulphides** at the Central Indian Ridge.
...
1. **(UPSC CSE Prelims 2020)** Consider the following pairs regarding ocean currents and the continents they pass through: (1) Benguela — Southern Africa; (2) Oyashio — Eastern Japan. Which of the pairs given above is/are correctly matched? — Both 1 and 2.

2. **(UPSC CSE Prelims 2018)** Which of the following phenomena might have influenced the evolution of life on the Earth? — Thermohaline circulation (ocean conveyor belt) plays a role in distributing nutrients and regulating climate.

3. **(UPSC CSE Prelims 2022)** With reference to Indian Ocean Dipole (IOD), which of the following statements is/are correct? — Positive IOD is associated with excess rainfall in India and deficient rainfall in Australia.

4. **(UPSC CSE Prelims 2016)** Which one of the following is the least likely to be the consequence of a positive IOD event in the Indian Ocean? — Below-normal monsoon rainfall over India.

### Mains

1. **(UPSC CSE Mains GS1 2020)** How do ocean currents and wind systems influence the distribution of rainfall over different parts of the world?

2. **(UPSC CSE Mains GS3 2021)** What is India's Deep Ocean Mission and how does it contribute to India's Blue Economy? Discuss.

3. **(UPSC CSE Mains GS1 2019)** Examine how the El Niño phenomenon affects Indian monsoon. Also discuss the role of the Indian Ocean Dipole in modulating the impact of El Niño.

4. **(UPSC CSE Mains GS1 2018)** Explain the structure of thermohaline circulation and its significance for global climate regulation. What are the implications of its weakening?
...
**For Prelims:**
- Cold currents → coastal deserts (Namib/Benguela; Atacama/Humboldt; Sahara coast/Canary; Baja California/California).
- Warm currents → warmer coasts, higher rainfall on windward side.
- Gulf Stream → NE to UK/Norway; Kuroshio = Pacific Gulf Stream.
- Thermohaline: driven by density (temperature + salinity); deep slow circulation (~1,000-year cycle); AMOC = Atlantic component.
- UNCLOS zones: 12 nm territorial sea; 24 nm contiguous; **200 nm EEZ**; 350 nm max continental shelf extension.
- **IOD:** Positive = more rain India + drought Australia; Negative = less rain India + more rain Australia.
- **El Niño:** Warming of E/central Pacific; weakens Walker Circulation; below-normal Indian monsoon.
- **La Niña:** Cooling of E/central Pacific; strengthens Walker Circulation; above-normal Indian monsoon.
- Mariana Trench: deepest at ~10,935 m; in western Pacific; Java Trench deepest in Indian Ocean.
- Avg salinity: 35 ppt; Red Sea highest (~42 ppt); Baltic Sea lowest (~7–8 ppt).

**For Mains:**
- Ocean currents question: Organise by warm/cold + ocean basin + effect on climate and rainfall (use the coastal aridity link for cold currents).
- El Niño/IOD: Emphasise the **interaction effect** — positive IOD can offset El Niño drought risk for India; cite years (1997, 2019).
- THC/AMOC: Connect to **climate change** — freshwater from melting ice weakens sinking, potentially collapsing AMOC; link to European climate, US sea level rise.
- Deep Ocean Mission: Connect to **Blue Economy**, **critical minerals** (cobalt for EV batteries), **food security** (seafloor minerals), and India's UNCLOS rights.
- UNCLOS: Always specify exact distances: 12 nm territorial sea; 200 nm EEZ; up to 350 nm continental shelf. India's EEZ = 2.37 million sq. km.
- For tides: Spring tides = new/full moon; neap tides = first/third quarter moon. Bay of Fundy = world's highest tidal range; Gulf of Khambhat = India's highest.
