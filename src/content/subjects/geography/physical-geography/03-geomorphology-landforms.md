---
layout: topic.njk
title: "Geomorphology & Landforms — Weathering, Erosion, Fluvial, Glacial & Aeolian Processes"
subject: geography
...
description: "UPSC notes on geomorphology — rocks, weathering, mass movement, fluvial landforms, glacial landforms, aeolian landforms, marine landforms, karst topography."
date: 2026-03-28
foundation: true
prelims: true
mains: true
...
1. **Igneous rocks** are formed when magma cools and solidifies (either below the surface as plutonic rocks or on the surface as volcanic rocks).
2. Igneous rocks are broken down by **weathering and erosion**, and the sediments are transported and deposited to form **sedimentary rocks** through compaction and cementation.
3. When sedimentary or igneous rocks are subjected to intense **heat and pressure** (metamorphism), they become **metamorphic rocks**.
4. Any rock type can be melted back into **magma**, restarting the cycle.
5. Metamorphic rocks can also be weathered to form sedimentary rocks, and igneous rocks can directly metamorphose without first becoming sedimentary.
...
- **India** — Meghalaya (Mawsmai, Krem Liat Prah — India's longest cave at ~34.8 km); Madhya Pradesh (Pachmarhi); Chhattisgarh (Kutumsar Cave)
