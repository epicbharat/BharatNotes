...
| **Thermosphere** | ~80–85 km to ~500–1,000 km | Increases sharply (up to ~2,000 °C) | Temperature is very high but air density is extremely low, so it would not feel "hot"; auroras (northern/southern lights) occur here; the International Space Station orbits in this layer (~408 km) |
...
## 5. Atmospheric Pressure and Pressure Belts

Atmospheric pressure is the weight of air per unit area at any point on Earth's surface. It decreases with altitude and varies with temperature and humidity.
...
## 9. Temperate (Extra-Tropical) Cyclones
...
- Exact composition percentages of atmospheric gases (N₂ 78%, O₂ 21%, Ar 0.93%)
- Altitude ranges and temperature trends of atmospheric layers
...
- Role of ITCZ shift in the Indian monsoon mechanism
- Tropical vs temperate cyclone comparison — a classic question
- Jet streams and monsoon onset/withdrawal — frequently asked
