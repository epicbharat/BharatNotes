---
layout: topic.njk
title: "World Mapping — Strategic Straits, Canals, Mountain Ranges & Important Places"
subject: geography
gs_papers:
  - gs1
...
- **H**ormuz: **P**ersian Gulf to Gulf of **O**man
- **M**alacca: **I**ndian Ocean to **S**outh China Sea
- **B**ab-el-Mandeb: **R**ed Sea to Gulf of **A**den
- **G**ibraltar: **M**editerranean to **A**tlantic
- **S**unda: **J**ava Sea to **I**ndian Ocean
- **T**aiwan: **S**outh China Sea to **E**ast China Sea
- **B**ering: **P**acific to **A**rctic

**Canals -- "S-P-K-G" (length order):**
- **G**rand Canal (China): 1,776 km (longest)
- **S**uez: 193 km
- **K**iel: 98 km
- **P**anama: 82 km

**Islands (top 4 by area) -- "Green New Bor Mad":**
- **Green**land > **New** Guinea > **Bor**neo > **Mad**agascar
