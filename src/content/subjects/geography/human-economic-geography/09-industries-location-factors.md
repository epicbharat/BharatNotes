...
| Factor | Explanation |
|--------|-------------|
| **Transport cost** | The cost of moving raw materials to the factory and finished goods to the market. Industries locate where this cost is lowest. |
| **Labour cost** | Cheap labour can pull an industry away from the least-transport-cost point, provided savings exceed additional transport cost. |
| **Agglomeration economies** | Clustering of industries reduces shared costs (infrastructure, services, skilled labour pool). Deglomeration occurs when overcrowding raises costs. |
...
|--------|-------------|---------|
| **Raw materials** | Industries using heavy/perishable raw materials locate near the source | Iron & steel near iron ore (Jamshedpur near Singhbhum ores) |
| **Power & energy** | Energy-intensive industries locate near power sources | Aluminium smelting near hydroelectric plants |
| **Transport** | Efficient rail/road/port connectivity reduces cost | Mumbai, Chennai — port-based industries |
| **Labour** | Availability of skilled/cheap labour | IT in Bengaluru (skilled), textiles in Tiruppur (cheap) |
| **Market proximity** | Consumer goods industries locate near demand centres | Bakeries, soft drinks in metro cities |
| **Capital** | Availability of banking and investment infrastructure | Mumbai (financial capital), Gujarat (entrepreneur culture) |
| **Government policy** | Tax incentives, SEZs, freight equalisation, subsidies | SEZs, industrial corridors, PLI schemes |
| **Climate** | Certain industries need specific climatic conditions | Cotton textiles in humid Mumbai (prevents thread breakage) |
| **Water** | Large quantities needed for cooling, processing, washing | Paper, steel, thermal power plants near rivers |
| **Agglomeration** | Existing industrial clusters attract ancillary industries | Pune auto cluster attracts component manufacturers |
...
|----------|-----------|----------|
| **Cottage/Household** | Family-based, minimal capital, traditional skills | Handloom, pottery, basket weaving |
| **Small-scale** | Investment up to Rs 10 crore in plant & machinery (MSMED Act 2006, revised) | Bakeries, garment units, small foundries |
| **Medium-scale** | Investment Rs 10-50 crore | Auto components, food processing |
| **Large-scale** | Investment above Rs 50 crore; mass production | Steel plants, automobile factories, oil refineries |

### By Raw Material

| Type | Raw Material Base | Examples |
|------|------------------|----------|
| **Agro-based** | Agricultural products | Sugar, cotton textiles, jute, tea, coffee, rubber |
| **Mineral-based** | Minerals and metals | Iron & steel, aluminium, cement, copper |
| **Forest-based** | Forest products | Paper, lac, plywood, furniture |
| **Marine-based** | Sea/ocean resources | Fish processing, sea salt, seaweed products |

### By Product Type

| Type | What They Produce | Examples |
|------|------------------|----------|
| **Consumer goods (light)** | Goods for direct consumption | Textiles, food products, electronics, cosmetics |
| **Capital/Producer goods (heavy)** | Goods used to make other goods | Machine tools, heavy machinery, steel |

### By Sector

| Sector | Activity | Examples |
|--------|----------|----------|
| **Primary** | Extraction of raw materials | Mining, forestry, fishing |
| **Secondary** | Manufacturing and processing | Steel, automobiles, textiles |
| **Tertiary** | Services supporting production | Banking, transport, insurance |
| **Quaternary** | Knowledge-based services | IT, R&D, consultancy |
| **Quinary** | Top-level decision-making | Government policy, senior management |
...
| Parameter | Data |
|-----------|------|
| **Global rank** | 2nd (after China's 960.8 MT in 2025) |
| **India's crude steel production (2025)** | 164.9 million tonnes |
| **Production capacity** | 200.33 MTPA (target: 300 MTPA by FY30) |
| **Crude steel (FY25)** | 151.14 MT |
| **Finished steel (FY25)** | 145.30 MT |
...
| Plant | Location | State | Capacity (MTPA) | Collaboration/Note |
|-------|----------|-------|-----------------|-------------------|
| **Bhilai Steel Plant** | Bhilai | Chhattisgarh | 7.0 | USSR collaboration (1959); SAIL's largest plant |
| **Rourkela Steel Plant** | Rourkela | Odisha | 4.2 (crude steel) | German collaboration; first to have LD converter |
| **Bokaro Steel Plant** | Bokaro | Jharkhand | 4.6 | USSR collaboration; Asia's largest at commissioning |
| **Durgapur Steel Plant** | Durgapur | West Bengal | 2.2 | UK collaboration |
| **IISCO (Burnpur)** | Burnpur | West Bengal | 2.9 | Oldest integrated plant (pre-independence origin) |

**Private Sector**

| Company | Key Locations | India Capacity (MTPA) |
|---------|--------------|----------------------|
| **Tata Steel** | Jamshedpur (Jharkhand), Kalinganagar & Meramandali (Odisha) | ~26.6 |
| **JSW Steel** | Vijayanagar (Karnataka), Dolvi (Maharashtra) | ~38.5 |
| **JSPL** | Angul (Odisha), Raigarh (Chhattisgarh) | ~8.6 (India) + 2.4 (Oman) |
...
| Parameter | Data |
|-----------|------|
| **India's global rank in cotton production** | Largest producer (~23% of world production) |
| **Cotton production (2024-25)** | ~294.25 lakh bales |
| **Major centres** | Mumbai, Ahmedabad, Coimbatore, Indore, Kanpur, Sholapur |
...
| Parameter | Data |
|-----------|------|
| **India's global share** | ~70% of global jute production |
| **Major belt** | Hooghly river basin — Kolkata, Howrah, Hooghly, 24 Parganas |
| **Raw material zone** | West Bengal, Bihar, Assam (Ganga-Brahmaputra delta) |
...
India is the **world's 2nd-largest silk producer** (after China) and the **largest consumer of silk**. India is unique in producing all **four commercial varieties**: Mulberry, Tropical Tasar, Oak Tasar, Muga, and Eri.

| Silk Variety | Major State |
|-------------|-------------|
| **Mulberry** | Karnataka (Mysuru-Bengaluru belt) — largest producer |
| **Tasar** | Jharkhand, Chhattisgarh |
| **Muga** | Assam (exclusive to India — GI-tagged) |
| **Eri** | Assam, Meghalaya |
...
| Parameter | Data |
|-----------|------|
| **FY25 revenue** | ~US$ 283 billion |
| **Export share** | US$ 224 billion (~79% of revenue) |
| **Top export market** | USA (54.1%), Europe (30.8%), UK (14.1%) |
| **Employment** | Over 5.4 million direct employees |

### Major IT Hubs and Location Factors

| City | Why This Location |
|------|------------------|
| **Bengaluru** | Pioneer — IISc, IIT, large talent pool; pleasant climate; early government support (Electronics City, 1978); Infosys, Wipro HQs |
| **Hyderabad** | HITEC City; proactive state policy (Chandrababu Naidu era); Microsoft, Google, Amazon campuses |
| **Pune** | Proximity to Mumbai; educational institutions; lower cost than Mumbai; Hinjewadi IT Park |
| **Chennai** | TIDEL Park, Siruseri IT corridor; port connectivity; automobile + IT synergy |
| **NCR (Gurugram-Noida)** | Proximity to political capital; huge consumer market; expressway connectivity |
...
| Cluster | States | Key Companies | Specialisation |
|---------|--------|---------------|----------------|
| **Chennai-Hosur-Bengaluru** | Tamil Nadu, Karnataka | Hyundai, Renault-Nissan, BMW, Royal Enfield, Daimler | Chennai is called the **"Detroit of India"**; ~45 manufacturing units in Tamil Nadu |
| **Pune-Nashik-Aurangabad** | Maharashtra | Tata Motors, Bajaj Auto, Mercedes, Force Motors | Two-wheelers, commercial vehicles, precision engineering |
| **Gurgaon-Manesar-Faridabad** | Haryana | Maruti Suzuki, Hero MotoCorp | Largest passenger car cluster |
| **Sanand-Hansalpur** | Gujarat | Tata Nano (now Tata Punch), Suzuki, MG Motor, Honda | Newer cluster; state incentives attracted investment |
| **Jamshedpur** | Jharkhand | Tata Motors (commercial vehicles) | Oldest cluster; near steel and mineral sources |
...
India's **National Industrial Corridor Development Programme (NICDP)** aims to create world-class manufacturing and investment zones along dedicated freight corridors.

| Corridor | Route | Length | States Covered | Key Nodes | Focus Sectors |
|----------|-------|--------|---------------|-----------|---------------|
| **DMIC** (Delhi-Mumbai) | Delhi to Mumbai along Western DFC | 1,504 km | UP, Haryana, Rajasthan, Gujarat, Maharashtra, MP | Dholera SIR, Shendra-Bidkin (Aurangabad), Greater Noida, Vikram Udyogpuri | Manufacturing, logistics, defence |
| **CBIC** (Chennai-Bengaluru) | Chennai to Bengaluru, extension to Mangalore | ~560 km | Tamil Nadu, Karnataka, Andhra Pradesh | Krishnapatnam, Tumakuru, Ponneri | Electronics, auto, heavy engineering |
| **AKIC** (Amritsar-Kolkata) | Amritsar to Dankuni (near Kolkata) along Eastern DFC | ~1,800 km | Punjab, Haryana, UP, Uttarakhand, Bihar, Jharkhand, West Bengal | Gamharia, Pragati Pura | Agro-processing, textiles, food processing |
| **ECEC** (East Coast) | Vizag to Chennai (Phase 1: VCIC) | ~800 km | Andhra Pradesh, Odisha, Tamil Nadu | Visakhapatnam, Kakinada, Yerpedu-Srikalahasti | Petroleum, pharma, IT, seafood |
| **BMIC** (Bengaluru-Mumbai) | Bengaluru to Mumbai | ~1,000 km | Karnataka, Maharashtra | Dharwad, Belgaum, Sangli | Innovation, manufacturing, job creation |
...
| Parameter | Data |
|-----------|------|
| **Total notified SEZs** | ~379 |
| **Operational SEZs** | ~265 |
| **Units operating in SEZs** | Over 6,200 |
| **Employment** | ~3.1 million people |
| **Geographic concentration** | ~64% in Tamil Nadu, Telangana, Karnataka, AP, and Maharashtra |
...
| Region | Country | Key Industries | Location Factors |
|--------|---------|---------------|-----------------|
| **Ruhr Valley** | Germany | Historically coal and steel; now diversified into logistics, high-tech, renewable energy | Rich coal deposits; Rhine-Ruhr river system for transport; dense rail network; skilled labour; EU market proximity |
| **Great Lakes / Manufacturing Belt** | USA (Michigan, Ohio, Illinois, Pennsylvania) | Automobiles (Detroit), steel (Pittsburgh), machinery | Iron ore (Mesabi Range), coal (Appalachian), Great Lakes waterway for cheap transport, large domestic market |
...
| Sector | Key Outcome |
|--------|-------------|
| **Mobile & Electronics** | Production surged 146% — from Rs 2.13 lakh crore (FY21) to Rs 5.25 lakh crore (FY25); mobile exports rose 8x to Rs 2 lakh crore |
| **Pharmaceuticals & Bulk Drugs** | India shifted from net importer (Rs 1,930 crore deficit in FY22) to net exporter (Rs 2,280 crore surplus in FY25) |
| **Solar PV Modules** | Investments of Rs 48,120 crore committed; ~38,500 direct jobs created (as of June 2025) |
| **Automobiles & Auto Components** | Budget allocation surged from Rs 347 crore (FY25) to Rs 2,819 crore (FY26) |
| **Textiles** | Allocation jumped from Rs 45 crore to Rs 1,148 crore in FY26 |

**Overall PLI impact (as of early 2025):**

| Metric | Figure |
|--------|--------|
| **Total applications approved** | 806 (across 14 sectors) |
| **Total investment realised** | ~Rs 1.76 lakh crore |
| **Total sales by PLI participants** | Over Rs 16.5 lakh crore |
| **Employment generated** | Over 12 lakh (direct + indirect) |
