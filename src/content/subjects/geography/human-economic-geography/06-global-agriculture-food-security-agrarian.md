---
layout: topic.njk
title: "Global Agriculture, Food Security & Agrarian Systems"
subject: geography
gs_papers:
  - gs1
...
**Amber Box:** Trade-distorting domestic support (e.g., price supports, input subsidies above certain levels) — must be reduced
**Green Box:** Minimally distorting support (e.g., direct income transfers decoupled from production, public stockholding at market prices) — permitted without limits
**Blue Box:** Production-limiting programme payments — partially exempt
