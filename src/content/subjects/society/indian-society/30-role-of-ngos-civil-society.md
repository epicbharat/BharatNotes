---
layout: topic.njk
title: "Role of NGOs, Civil Society & SHGs — Grassroots Democracy & Social Transformation"
subject: society
gs_papers:
  - gs1
...
description: "UPSC notes on NGOs, civil society organisations, SHGs, FCRA regulation, public participation in governance, and grassroots democratic institutions."
sub_chapter: 30
chapter: 30
date: 2026-03-28
foundation: true
...
*Sources: PIB (pib.gov.in), MHA (mha.gov.in), MoRD (rural.nic.in), NABARD (nabard.org), India Code (indiacode.nic.in), NGO DARPAN (ngodarpan.gov.in), NRLM (nrlm.gov.in), MCA (mca.gov.in). For current affairs on governance, civil society developments, and social issues, visit [Ujiyari.com](https://ujiyari.com).*
