---
layout: topic.njk
title: "Population, Urbanisation & Migration — Demographic Dividend, Smart Cities & Internal Migration"
subject: society
...
| **Dependency ratio** | Currently ~49% (declining — more workers per dependent) |
| **Peak working-age share** | Expected around 2035-2040 |
...
| **Waste** | 62 million tonnes of solid waste generated annually; only ~75% collected, ~30% processed |
...
|--------|------|-------|--------|
| **Smart Cities Mission** | 2015 | 100 cities with tech-enabled urban infrastructure | Officially closed March 2025; 94% of 8,067 projects completed (Rs 1.51 lakh crore) |
| **AMRUT** | 2015 | Water supply, sewerage, urban transport in 500 cities | AMRUT 2.0 launched 2021; target: universal water supply in all statutory towns |
...
| **Limitations** | 1979 Act poorly enforced; most migrants are in informal sector; no comprehensive migration policy |
...
| **Census 2011** | Last completed Census — population 121 crore |
| **Census 2021** | **Delayed** due to COVID-19; expected by March 2027 |

> **For Mains:** The Census delay means India is governing with 15-year-old data. Policy decisions on welfare targeting (Below Poverty Line lists), constituency delimitation, resource allocation, and urban planning are all based on Census 2011 figures. The delay also affects the Finance Commission's horizontal devolution formula and MGNREGA wage benchmarking. Discuss the consequences of outdated demographic data for governance.
...
### Prelims Focus Areas
- India's TFR, population, growth rate
- Demographic dividend definition and India's window
- Census — conducted by whom, legal basis, frequency
- Smart Cities Mission — number of cities, closure date
- AMRUT — target cities, focus areas
- PMAY-Urban — target, progress
- Article 19(1)(d) and (e) — right to move and reside
- Remittances — India's global rank, amount

### Mains Focus Areas
- Demographic dividend — opportunity or ticking bomb?
- North-South demographic divide and its political implications
- Urbanisation challenges — housing, water, governance
- Migration and invisibility of informal workers
- COVID-19 reverse migration — lessons and policy response
- Census delay — implications for governance
- 74th Amendment and urban governance reform
- Smart Cities vs organic urbanisation — what worked?
- Remittances and diaspora policy
