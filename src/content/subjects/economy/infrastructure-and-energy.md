---
layout: topic.njk
title: "Infrastructure & Energy — NIP, Gati Shakti, Renewables & Nuclear"
subject: economy
gs_papers:
  - gs3
...
1. India's nuclear programme is based on a three-stage approach.
2. The second stage involves Pressurised Heavy Water Reactors.
3. The third stage envisages using thorium resources.
...
Which of the above are related to renewable energy?
(a) 1 and 3 only
(b) 1, 2 and 3 only
(c) 2 and 4 only
(d) 1, 2, 3 and 4
...
**Q. Which of the following best describes the objective of PM Gati Shakti? (2022)**
(a) Accelerating COVID-19 vaccination
(b) Multimodal connectivity infrastructure planning
(c) Financial inclusion in rural areas
...
- [Economy Subject Page](https://ujiyari.com/subjects/economy/) — for infrastructure project updates, energy policy changes
- [Editorials](https://ujiyari.com/editorials/) — analysis on energy transition, DISCOM reforms, infrastructure financing
- [Daily Current Affairs](https://ujiyari.com/daily/) — solar capacity milestones, highway completions, scheme launches
