---
layout: topic.njk
title: "India's Trade Policy — Anti-Dumping, Export Promotion & WTO Disputes"
subject: economy
gs_papers:
  - gs3
...
2. Consider the following statements regarding the WTO Appellate Body:
   (a) It has been non-functional since 2019 due to US blocking new appointments
   (b) India is a member of the Multi-Party Interim Appeal Arbitration Arrangement (MPIA)
   Which of the statements given above is/are correct? *(CSE Prelims pattern)*
