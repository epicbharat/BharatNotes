---
layout: topic.njk
title: "RBI & Monetary Policy — MPC, Inflation Targeting & Tools"
subject: economy
gs_papers:
  - gs3
...
3. Voting is conducted by secret ballot
...
**Standing Deposit Facility (SDF) — introduced April 1, 2022:**
The SDF replaced the **fixed rate reverse repo** as the floor of the rate corridor. Unlike the reverse repo, the SDF does not require the RBI to provide collateral when absorbing excess liquidity from banks. This gives the RBI more flexibility in liquidity management.
