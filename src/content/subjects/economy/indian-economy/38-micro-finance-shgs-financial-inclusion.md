...
1. With reference to the SHG-Bank Linkage Programme in India, which of the following statements is/are correct?
   (1) The programme was launched by NABARD in 1992.
   (2) It is the world's largest microfinance programme by household coverage.
   (3) Under the programme, SHGs must be registered as legal entities before receiving bank credit.
   Select the correct answer:
   (a) 1 only
   (b) 1 and 2 only
   (c) 2 and 3 only
   (d) 1, 2, and 3
   **Answer: (b)** — SHGs are informal groups; registration is not mandatory.

2. The Malegam Committee (2011) was constituted by the Reserve Bank of India primarily to:
   (a) Review the interest rate structure of scheduled commercial banks
   (b) Recommend a regulatory framework for Non-Banking Financial Company–Micro Finance Institutions
   (c) Suggest reforms in the Self-Help Group–Bank Linkage Programme
   (d) Study the feasibility of a National Microfinance Development Bank
   **Answer: (b)**

3. Under the current RBI harmonised microfinance framework, a loan is classified as a microfinance loan if the borrowing household has an annual income not exceeding:
   (a) ₹1,20,000 (rural) and ₹2,00,000 (urban)
   (b) ₹2,50,000
   (c) ₹3,00,000
   (d) ₹5,00,000
   **Answer: (c)**

4. Consider the following about Pradhan Mantri Jan-Dhan Yojana (PMJDY):
   (1) It was launched in August 2014.
   (2) All accounts are zero-balance accounts with no overdraft facility.
   (3) RuPay debit cards are issued to account holders.
   (4) More than 50% of account holders are women.
   Which of the above are correct?
   (a) 1 and 3 only
   (b) 1, 3, and 4 only
   (c) 2 and 4 only
   (d) 1, 2, 3, and 4
   **Answer: (b)** — Statement 2 is incorrect; overdraft up to ₹10,000 is available after 6 months.

### Mains

1. "The Andhra Pradesh microfinance crisis of 2010 exposed a fundamental tension between financial inclusion and financial exploitation." Discuss the causes of the crisis, the regulatory response that followed, and lessons for India's microfinance sector. (250 words)

2. Analyse the contribution of the SHG-Bank Linkage Programme to women's empowerment and financial inclusion in rural India. What challenges does the programme face in ensuring sustainable livelihoods? (250 words)

3. The JAM Trinity (Jan Dhan–Aadhaar–Mobile) has transformed the architecture of welfare delivery in India. Critically examine its achievements and limitations with reference to financial inclusion and Direct Benefit Transfer. (250 words)

4. "Microfinance in India has drifted from its original social mission towards profit maximisation." Critically evaluate this statement and suggest regulatory and institutional measures to restore the pro-poor orientation of the sector. (150 words)
