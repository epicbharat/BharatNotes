---
layout: topic.njk
title: "Indian Agriculture — Crops, MSP, Food Security & Reforms"
subject: economy
...
- **Context:** Introduced in the mid-1960s alongside the Green Revolution to incentivise adoption of HYV seeds. CACP recommends MSP for 23 crops (7 cereals, 5 pulses, 7 oilseeds, 4 commercial crops). Government currently uses A2+FL formula (not the Swaminathan Commission's C2+50% recommendation). MSP is not legally enforceable — it is an administrative price. Effective procurement is largely limited to wheat and rice in a few states (Punjab, Haryana, MP).
- **UPSC Relevance:** GS3 Economy & Agriculture — Prelims: 23 crops, recommended by CACP, A2+FL formula vs C2+50% (Swaminathan), not legally binding, FCI as procurement agency; Mains: should MSP be given legal backing (fiscal burden vs farmer income security), MSP and crop diversification problem (incentivises wheat-rice monoculture), Swaminathan Commission's C2+50% vs A2+FL — why the formula matters, effectiveness of MSP vs DBT (PM-KISAN) as income support.
...
- **Context:** Enacted on 10 September 2013, building on the Right to Food movement and the Supreme Court's 2001 orders in PUCL v. Union of India. Originally priced at Rs. 3/2/1 per kg for rice/wheat/coarse grains; now provided free after PMGKAY was subsumed into NFSA from January 2024. Covers ~81.35 crore beneficiaries (~two-thirds of the population). This is the subject of India's WTO public stockholding debate, where India demands a permanent solution arguing that outdated 1986-88 reference prices inflate subsidy calculations.
- **UPSC Relevance:** GS3 Economy & Agriculture — Prelims: enacted 2013, 5 kg/person/month, 75% rural + 50% urban coverage, now free (not Rs. 3/2/1), PMGKAY merged into NFSA from January 2024, maternity benefit of Rs. 6,000 for pregnant women; Mains: right to food vs fiscal sustainability, is free food grain policy sustainable long-term, WTO public stockholding controversy, NFSA's role in poverty reduction, One Nation One Ration Card (ONORC) portability reform.
