...
description: "India's farm subsidies — input subsidies, MSP/FCI procurement, WTO AoA Green/Amber/Blue Box classification, India's Peace Clause, de minimis limits and subsidy rationalisation debate for UPSC GS3."
date: 2026-04-04
tags:
  - gs3
  - agriculture
...
| Peace Clause | 2013 Bali agreement protecting India's food procurement from WTO challenge even if it exceeds 10% cap |
| De minimis | Minimum allowed trade-distorting support: 10% of value of agricultural production for developing countries |
...
### Green Box
Minimally trade-distorting measures, permitted without limits. Examples include: government-funded food security stockholding (PDS), domestic food aid, direct income support decoupled from production (e.g., PM-KISAN), agricultural research, infrastructure development, pest/disease control, training, and extension services.

**India's Green Box**: PM-KISAN (Rs 6,000 per year per farmer family — decoupled income support), agricultural research, crop insurance premium subsidy.

### Amber Box
Nearly all domestic support measures that distort production and trade fall in the Amber Box — including input subsidies (fertiliser, power, irrigation), and MSP-based price support procurement. These are subject to reduction commitments (Aggregate Measure of Support — AMS). For **developing countries**, the de minimis threshold is **10% of the value of agricultural production** for product-specific and non-product-specific support separately. India regularly invokes this de minimis provision.

### Blue Box
Production-limiting subsidies (deficiency payments, area-based payments tied to base acreage). Currently **no spending limits**. India does not significantly use the Blue Box.
...
## India-USA Farm Subsidy Disputes

India and the United States have had repeated WTO disputes on farm subsidies. The US has challenged India's sugar subsidies and cotton support. India, in turn, points to the massive farm subsidies ($20 billion+ annually) under the US Farm Bill, which India argues are far more trade-distorting than India's price support for food security.
...
**Key numbers**: Fertiliser subsidy FY24-25 = Rs 1.91 lakh crore total; DAP special subsidy Rs 3,500/tonne; de minimis = 10% for developing countries; Bali MC9 = 2013; KCC rate = 4% (with incentive).
