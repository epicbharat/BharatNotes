...
description: "India's irrigation systems — types (canal, tank, groundwater, micro), ultimate potential, coverage gaps, PMKSY, AIBP, micro-irrigation and water use efficiency for UPSC GS3."
date: 2026-04-04
tags:
  - gs3
  - agriculture
...
| Command Area | Area that can be served by an irrigation project's canal system |
| Water Use Efficiency | Proportion of water diverted or extracted that reaches the plant root zone |

---

## India's Irrigation Potential — Verified Figures

India's **ultimate irrigation potential** has been estimated at **139.5 million hectares (mha)**:
- Major and medium irrigation schemes: **58.5 mha**
- Minor irrigation (surface): **15 mha**
- Groundwater exploitation: **66 mha**
...
### 2. Tank Irrigation
Rainwater harvested in tanks (small reservoirs). Historically significant in peninsular India — Tamil Nadu, Andhra Pradesh, Karnataka, Maharashtra. Accounts for approximately **1.6%** of current irrigation. Many traditional tanks have fallen into disrepair; revival programmes (RRR component of PMKSY-HKKP) are ongoing.

### 3. Groundwater Irrigation (Wells and Tubewells)
The single largest source: **tubewells and wells account for ~55.2%** of total irrigated area. The groundwater economy has driven the Green Revolution but has created severe sustainability concerns. As of 2024, of 6,746 assessed groundwater units, **751 (11.13%) are over-exploited**, 206 (3.05%) are critical. Annual groundwater extraction stands at 245.64 bcm against a recharge of 446.90 bcm (stage of extraction: 60.47%).
...
**Pradhan Mantri Krishi Sinchayee Yojana (PMKSY)**, launched in **2015-16**, is the umbrella irrigation scheme with four components:

| Component | Goal |
|-----------|------|
| AIBP (Accelerated Irrigation Benefits Programme) | Complete long-pending major/medium irrigation projects |
| Har Khet Ko Pani (HKKP) | Create new water sources; extend distribution to uncovered farms |
| Per Drop More Crop (PDMC) | Promote drip/sprinkler micro-irrigation |
| WDC-PMKSY | Watershed development for rain-fed areas |
...
**Structure irrigation answers** around: Potential created vs utilised gap → Types with data → Key policy (PMKSY, its 4 components) → Efficiency challenge → Way forward (micro-irrigation, participatory management, groundwater regulation).

**Critical numbers to memorise**: Ultimate irrigation potential = 139.5 mha; 55% GCA irrigated (FY21); 55.2% from groundwater; 751 over-exploited units (2024 assessment); PDMC = 95.58 lakh ha covered; drip efficiency 70-80% vs India's 35-40%.

Cross-link to Ujiyari.com for current affairs on PMKSY extension, groundwater assessment 2024, and Jal Shakti Abhiyan updates.
