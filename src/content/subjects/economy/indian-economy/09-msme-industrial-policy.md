---
layout: topic.njk
title: "MSME Sector & Industrial Policy — Make in India, PLI & Manufacturing"
subject: economy
...
- **Context:** Launched on 25 September 2014, initially covering 25 sectors (later expanded to 27). Manufacturing's share of GDP has remained around 17% (target: 25%), though FDI inflows increased significantly post-launch. Complemented by PLI schemes (2020-21), Startup India, Ease of Doing Business reforms (India improved from 142nd to 63rd rank in World Bank DBR), and NSWS (National Single Window System). The "China Plus One" strategy by global firms offers India an opportunity.
- **UPSC Relevance:** GS3 Economy — Prelims: launched September 2014, 25 sectors initially, goal of 25% manufacturing share of GDP, link with FDI liberalisation (automatic route expanded); Mains: has Make in India achieved its manufacturing targets (17% vs 25% target), complementary policies needed (land, labour, logistics reforms), Make in India vs China Plus One — India's opportunity in global supply chain diversification, comparison of industrial policy approaches (state-led vs incentive-based).
...
- **Context:** Introduced in 2020-21 with a total outlay of Rs 1.97 lakh crore across 14 sectors including electronics, pharma, telecom, auto components, solar modules, textiles, food processing, and advanced chemistry cells. Incentive: 4-6% on incremental sales for 5 years after meeting investment and production thresholds. By March 2025, realised investments reached ~Rs 1.76 lakh crore with 806 approved applications. Mobile phone exports surged from near-zero to over USD 12 billion, largely attributed to PLI.
- **UPSC Relevance:** GS3 Economy — Prelims: 14 sectors, Rs 1.97 lakh crore outlay, incentive of 4-6% on incremental sales, 5-year period, key sectors (electronics, pharma, auto, solar); Mains: evaluate PLI effectiveness — genuine import substitution or mere assembly operations, comparison with East Asian industrial policy models, WTO compliance of production subsidies (SCM Agreement), should PLI be extended beyond 14 sectors, PLI's impact on employment generation vs capital-intensive manufacturing.
