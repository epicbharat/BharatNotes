---
layout: topic.njk
title: "Global Financial Institutions — IMF, World Bank Group, ADB, AIIB, NDB"
subject: economy
...
1. **Quota realignment at IMF** — EMDCs are under-represented relative to their share of global GDP and trade
2. **Voting power reform at World Bank** — developing country voice needs to increase
3. **Governance of AIIB and NDB** — India pushes for de-politicised, merit-based governance
4. **South-South cooperation** — NDB as an alternative to Western-dominated Bretton Woods institutions; aligned with India's G20 presidency themes (2023) on reforming multilateral development banks
