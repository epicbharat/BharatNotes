---
layout: topic.njk
title: "Poverty, Inequality & Employment — Measurement, Schemes & Skills"
subject: economy
gs_papers:
  - gs3
...
**Q. "__(blank)__ is a situation in which more persons are employed on a job than are optimally required." (2013)**
...
- [Economy Subject Page](https://ujiyari.com/subjects/economy/) — for PLFS data releases, MGNREGA updates, skill development news
- [Editorials](https://ujiyari.com/editorials/) — analysis on inequality, gig economy regulation, labour code implementation
- [Daily Current Affairs](https://ujiyari.com/daily/) — poverty data, employment scheme launches, demographic trends
