---
layout: topic.njk
title: "Classical Languages of India — Sanskrit, Tamil & the Dravidian Linguistic Tradition"
...
1. High antiquity of early texts/recorded history — **1,500 to 2,000 years**
2. A **body of ancient literature** considered a valuable heritage by generations of speakers
3. The literary tradition must be **original** (not borrowed from another speech community)
4. The classical language and literature must be **distinct from later forms** or offshoots — a living language, but with a distinct ancient body of work
...
1. The regional language (mother tongue)
2. Hindi (or another Indian language in Hindi-speaking states)
3. English
