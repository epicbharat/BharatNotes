---
layout: topic.njk
title: "Mughal Art, Architecture & Cultural Legacy — Miniatures, Monuments & Din-i-Ilahi"
...
1. **Architectural innovation** — garden-tomb tradition (Humayun → Taj Mahal), char-bagh layout, pietra dura, double dome — all of which entered the vocabulary of Indian architecture
2. **Painting tradition** — emergence of a distinctly Indian naturalist miniature tradition distinct from Persian originals
3. **Religious pluralism** — Akbar's Sulh-i-Kul remains a model of inclusive governance debated to this day
4. **Language** — Mughal-era Persian patronage created conditions for the flowering of Urdu (synthesising Persian, Arabic, and Khari Boli/Braj) as a literary language
