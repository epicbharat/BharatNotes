---
layout: topic.njk
title: "Constitutional Amendments, Schedules & Special Provisions"
subject: polity
...
- **Definition:** The Constitution (Forty-second Amendment) Act, 1976 — the most sweeping and comprehensive amendment in Indian constitutional history, enacted during the Internal Emergency (25 June 1975 to 21 March 1977), which came into effect on 3 January 1977. It added "Socialist," "Secular," and "Integrity" to the Preamble; introduced 10 Fundamental Duties in a new Part IVA (Article 51A) based on the Sardar Swaran Singh Committee recommendations; added three DPSPs (Article 39A — free legal aid, Article 43A — worker participation in management, Article 48A — environment protection); expanded Article 31C to give all DPSPs primacy over Fundamental Rights (later struck down by Minerva Mills, 1980); transferred five subjects from the State List to the Concurrent List (education, forests, weights and measures, protection of wild animals and birds, administration of justice); curtailed judicial review and the powers of the Supreme Court and High Courts; extended Lok Sabha and State Assembly terms from 5 to 6 years; and made constitutional amendments non-justiciable — earning it the label "Mini-Constitution."
- **Context:** Passed during the Internal Emergency under Prime Minister Indira Gandhi, based on the recommendations of the Swaran Singh Committee (constituted in 1976 under then External Affairs Minister Swaran Singh). The amendment Bill was introduced in the Lok Sabha on 1 September 1976 and passed with minimal opposition — most Opposition leaders were in prison under preventive detention during the Emergency. The sweeping nature of the changes was described by constitutional scholar Granville Austin as an attempt to "defang" both the judiciary and the federal structure. Many of its most controversial provisions were subsequently reversed or modified: the 43rd Amendment (1977) restored the pre-Emergency position on several judicial and civil liberty provisions; the 44th Amendment (1978) restored Lok Sabha/Assembly terms to 5 years, restored judicial review, removed right to property from FRs (Article 300A), replaced "internal disturbance" with "armed rebellion" as emergency ground, and required written Cabinet advice for emergency proclamation. However, several 42nd Amendment provisions survived and remain in force: "Socialist," "Secular," and "Integrity" in the Preamble (confirmed as basic structure by SC in November 2024), Fundamental Duties (Part IVA), DPSPs under Articles 39A, 43A, and 48A, the transfer of five subjects to the Concurrent List, and the explicit obligation of the President to act on CoM advice (Article 74).
- **UPSC Relevance:** GS2 Polity — Prelims: nicknamed "Mini-Constitution," came into effect 3 January 1977, based on Swaran Singh Committee, what it added to the Preamble (Socialist, Secular, Integrity), Fundamental Duties (Part IVA — 10 duties under Article 51A), DPSPs added (39A — free legal aid, 43A — worker participation, 48A — environment), five subjects transferred from State to Concurrent List (remember "EFWPA" — Education, Forests, Weights and measures, Protection of wild animals and birds, Administration of justice), expanded Article 31C to all DPSPs (struck down in Minerva Mills, 1980), curtailed judicial review; Mains: was the 42nd Amendment a democratic necessity or an authoritarian power grab during the Emergency, trace which provisions survived (Preamble changes, Fundamental Duties, DPSPs, Concurrent List transfers) and which were reversed (judicial review curtailment, Lok Sabha term extension, non-justiciability of amendments, Article 31C expansion), its lasting impact on Indian federalism (Concurrent List expansion centralised power), compare with the 44th Amendment as the corrective counterpart.
