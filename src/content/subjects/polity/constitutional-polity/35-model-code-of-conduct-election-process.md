---
layout: topic.njk
title: "Model Code of Conduct & Election Process — ECI, EVM, VVPAT"
subject: polity
gs_papers:
  - gs2
...
1. **Flying Squads** and **Static Surveillance Teams** — monitor campaign violations, cash and liquor movement
2. **Complaints** to ECI — parties and citizens can report MCC violations; ECI issues notices to violators
3. **Censuring** candidates and parties for violations (with public statements)
4. **Directing removal** of campaign materials, banners, and illegal hoardings
5. **Invoking criminal provisions** of IPC, RPA 1951, and CrPC for serious violations
