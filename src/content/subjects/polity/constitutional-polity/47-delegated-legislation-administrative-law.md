...
description: "Delegated/subordinate legislation, types, Henry VIII clauses, ultra vires doctrine, judicial review, In Re Delhi Laws Act 1951, Parliamentary oversight via Committees on Subordinate Legislation — UPSC GS2."
date: 2026-04-04
tags:
  - gs2
  - polity
...
1. **Exceeds the scope** of the parent Act (substantive ultra vires)
2. **Violates the Constitution** — including Fundamental Rights
3. **Fails to follow the prescribed procedure** for making the instrument (procedural ultra vires)
4. **Delegates essential legislative functions** — a legislature cannot sub-delegate the power to make policy (against the maxim *delegatus non potest delegare*)
5. **Is unreasonable or mala fide** — courts can strike down arbitrary delegated instruments
...
**Cross-link:** For current affairs on executive ordinances and rule-making controversies, follow [Ujiyari.com](https://ujiyari.com).
