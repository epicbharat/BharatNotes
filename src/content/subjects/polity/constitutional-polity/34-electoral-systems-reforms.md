---
layout: topic.njk
title: "Electoral Systems & Reforms — ECI, Delimitation, NOTA & One Nation One Election"
subject: polity
...
1. **Phase 1** — Simultaneous elections to the Lok Sabha and all State Legislative Assemblies.
2. **Phase 2** — Municipal and panchayat elections within 100 days of the general election.
3. **Single Electoral Roll and Single EPIC** for all three tiers of government (Union, state and local) to avoid duplication of effort.
4. **Constitutional amendments** to Articles 82, 83 and 327, and insertion of a new Article 82A with seven sub-clauses.
