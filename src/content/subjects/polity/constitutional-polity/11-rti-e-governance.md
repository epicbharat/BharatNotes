...
- **Context:** Replaced the never-operationalised Freedom of Information Act, 2002; rooted in the Supreme Court's recognition in *State of UP v. Raj Narain* (1975) that the right to information is implicit in the right to freedom of speech and expression. The RTI Amendment Act, 2019 changed the tenure and salary of CIC/SICs from being fixed by statute to being determined by the Central Government. Section 8 lists 10 exemptions from disclosure; Section 4 mandates proactive (suo motu) disclosure.
- **UPSC Relevance:** GS2 Polity & Governance — Prelims: Section 4 (suo motu disclosure), Section 8 (10 exemptions), Section 19 (two-tier appeal), Section 20 (penalties up to Rs 25,000), 30-day response time, 2019 Amendment (tenure/salary change); Mains: RTI as a tool for transparency and accountability, challenges (vacant IC positions, delayed disposals, whistleblower safety), did the 2019 Amendment dilute RTI independence, comparison with freedom of information laws globally.
...
- **Context:** Announced by Prime Minister Narendra Modi; builds on earlier National e-Governance Plan (NeGP) initiatives and encompasses India Stack (Aadhaar-UPI-Account Aggregator), DigiLocker, UMANG, and other digital public infrastructure platforms. India's UPI is now the world's largest real-time payment system (~49% of global real-time transactions). The Digital Personal Data Protection Act (DPDP), 2023 provides the data privacy framework.
- **UPSC Relevance:** GS2 Governance & GS3 Economy — Prelims: nine pillars, launch year (2015), key platforms (UPI, DigiLocker, UMANG, Aadhaar), India Stack components; Mains: digital divide (rural vs urban, gender gap), e-governance and citizen empowerment, India Stack as a global DPI model for developing countries, privacy vs surveillance concerns (Aadhaar, DPDP Act), DBT and leakage reduction through digital governance.
