---
layout: topic.njk
title: "Modern Physics & Nuclear Science — Radioactivity, Fission, Fusion & Atomic Energy"
...
description: "UPSC notes on modern physics and nuclear science — radioactivity, nuclear fission, fusion, atomic structure, X-rays, laser, semiconductor physics, India's nuclear programme."
date: 2026-03-28
foundation: true
prelims: true
mains: true
tags: [general-science, sub-topic]
---
...
| Type | Particle Emitted | Charge | Mass | Penetrating Power | Stopped By |
|------|-----------------|--------|------|-------------------|------------|
| **Alpha (a)** | Helium nucleus (2 protons + 2 neutrons) | +2 | 4 amu | Lowest | Sheet of paper or skin |
| **Beta (b)** | Electron (or positron) | -1 (or +1) | ~0 | Moderate | Aluminium sheet (~few mm) |
| **Gamma (g)** | High-energy electromagnetic radiation (photon) | 0 | 0 | Highest | Thick lead or concrete |

### 2.2 Laws of Radioactive Decay
...
### 2.3 Half-Life and Its Applications

| Isotope | Half-Life | Application |
|---------|-----------|-------------|
| **Carbon-14** | 5,730 years | Carbon dating of archaeological specimens (up to ~50,000 years old) |
| **Uranium-238** | 4.5 billion years | Dating of rocks and geological formations |
...
Carbon-14 is continuously formed in the upper atmosphere when cosmic ray neutrons interact with nitrogen-14. Living organisms absorb C-14 through the food chain. When an organism dies, C-14 intake stops and the existing C-14 begins to decay. By measuring the ratio of C-14 to C-12 in a sample, scientists can determine the age of organic material up to approximately 50,000 years.
...
|------|-------------|-------------|
| **Uncontrolled chain reaction** | Exponential multiplication of fission events | Nuclear weapons (atomic bomb) |
| **Controlled chain reaction** | Neutron population maintained at a steady level using control rods | Nuclear power reactors |
...
| **Shielding** | Protects workers from radiation | Concrete, lead, steel |

### 3.4 Types of Nuclear Reactors

| Type | Fuel | Moderator | Coolant | Example |
|------|------|-----------|---------|---------|
| **Pressurised Heavy Water Reactor (PHWR)** | Natural uranium | Heavy water | Heavy water | India's main reactor type (Stage I) |
| **Pressurised Water Reactor (PWR)** | Enriched uranium | Light water | Light water | Most common globally (60%+ of reactors) |
...
| Requirement | Details |
|-------------|---------|
| **Extreme temperature** | ~150 million degrees C (10 times hotter than the Sun's core) to overcome electrostatic repulsion |
...
### 4.3 ITER (International Thermonuclear Experimental Reactor)
...
**Forward bias:** p-side connected to positive terminal; current flows (low resistance).
**Reverse bias:** p-side connected to negative terminal; negligible current (high resistance).
...
Conceived by Homi Jehangir Bhabha in the 1950s, the programme aims to utilise India's abundant thorium reserves for long-term energy security.

| Stage | Reactor Type | Fuel | Product |
|-------|-------------|------|---------|
| **Stage I** | Pressurised Heavy Water Reactors (PHWRs) | Natural uranium (U-238 with 0.7% U-235) | Plutonium-239 (from U-238 transmutation) |
| **Stage II** | Fast Breeder Reactors (FBRs) | MOX fuel (Pu-239 + U-238) | More Pu-239 (breeds more fuel than consumed) + U-233 (from thorium blanket) |
...
| **Nuclear power generation (FY 2024-25)** | 56.7 TWh (~3% of total power) |
| **Under construction** | ~6.6 GW |
| **Planned** | ~7 GW |
| **Long-term target** | 100 GW by 2047 |

### 8.3 Prototype Fast Breeder Reactor (PFBR)
...
**Significance of Pokhran-I (1974):** India became the first nation outside the five permanent members of the UN Security Council to conduct a confirmed nuclear test. It led to the formation of the Nuclear Suppliers Group (NSG) to control nuclear technology exports.
...
## Part IX -- Radiation Hazards and Nuclear Safety
...
### 9.2 Units of Radiation Measurement
...
| **Sievert (Sv)** | Effective dose (accounts for type of radiation) | 1 Sv = significant health risk; safe limit: ~1 mSv/year for public |

### 9.3 Major Nuclear Accidents

| Accident | Year | Country | Severity (INES Scale) | Impact |
|----------|------|---------|-----------------------|--------|
| **Chernobyl** | 1986 | Soviet Union (Ukraine) | Level 7 (Maximum) | Steam explosion + fire; 31 immediate deaths; large-scale radioactive contamination across Europe |
| **Fukushima Daiichi** | 2011 | Japan | Level 7 | Earthquake + tsunami triggered meltdowns in three reactors; massive evacuation; no immediate radiation deaths |
...
**For Prelims:** Focus on factual details -- types of radioactive decay (alpha, beta, gamma) and their properties, nuclear reactor components (moderator, coolant, control rods), differences between fission and fusion, Pokhran test dates, and India's three-stage nuclear programme stages.

**For Mains GS-III:** Frame answers on nuclear energy as a clean energy source, India's nuclear doctrine, ITER and fusion energy prospects, and radiation safety challenges. Use specific data -- 25 reactors, 8,880 MW, 3% of power generation.
