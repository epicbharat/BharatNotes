...
description: "UPSC notes on atomic structure — Dalton's atomic theory, subatomic particles, Bohr model, quantum numbers, periodic table (Mendeleev to modern), periodic trends, chemical bonding, isotopes, and radioactivity."
sub_chapter: 1
date: 2026-03-27
foundation: true
prelims: true
...
**Cross-links:**
- Nuclear energy and India's three-stage nuclear programme — [Nuclear Technology & Energy](/subjects/general-science/physics/)
- Radioactive waste management — links to Environment (GS-3)
- Critical minerals and rare earth elements — [Metals, Non-Metals & Alloys](/subjects/general-science/chemistry/metals-nonmetals-alloys/)
