---
layout: topic.njk
title: "Urban Disaster Risk, Building Safety Codes & Earthquake-Resistant Construction"
...
| Feature | Urban Context | Implication for Disaster |
|---------|--------------|-------------------------|
| **Population density** | Thousands per square km | Single event affects large numbers |
| **Vertical construction** | Multi-storey buildings | Collapse traps more people |
| **Critical infrastructure concentration** | Hospitals, power plants, water treatment in one city | Infrastructure failure creates cascading effects |
| **Interdependence** | Power → water → hospitals → economy | Chain failure propagates rapidly |
| **Informal settlements** | Slums on hazard-prone land | Highest vulnerability, lowest coping capacity |
| **Governance complexity** | Multiple jurisdictions | Coordination failures in response |
...
| Zone | Hazard Level | Key Areas |
|------|-------------|-----------|
| **Zone II** | Low | Southern peninsular India (most of Tamil Nadu, Andhra Pradesh interior) |
| **Zone III** | Moderate | Mumbai, Kolkata, Bhubaneswar, Lucknow |
| **Zone IV** | High (Severe) | **Delhi**, Chandigarh, Patna, Shimla, Jammu, Dehradun, northern UP |
| **Zone V** | Very High (Very Severe) | Kashmir valley, western Himachal Pradesh, eastern Uttarakhand, Kutch (Gujarat), northeast India, Andaman & Nicobar Islands |
...
| Term | Meaning |
|------|---------|
| **IS 1893** | Bureau of Indian Standards seismic design code for structures |
| **IS 13920** | BIS code for ductile detailing of RC structures in seismic zones |
| **NBC 2016** | National Building Code of India 2016 |
| **USAR** | Urban Search and Rescue |
| **INSARAG** | International Search and Rescue Advisory Group — UN-linked USAR coordination body |
| **Ductile detailing** | Construction technique allowing buildings to deform without sudden collapse |
| **SCADA** | Supervisory Control and Data Acquisition — industrial control systems (vulnerable to cyber-physical cascades) |
| **Cascading failure** | One system failure triggering failures in connected systems |
| **AMRUT 2.0** | Atal Mission for Rejuvenation and Urban Transformation (2021-26) |
| **Build Back Better** | Post-disaster reconstruction principle: restore to higher safety standard than pre-disaster |
| **Floodplain** | Land adjacent to a river naturally prone to inundation — construction here increases flood risk |
