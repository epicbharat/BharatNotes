---
layout: topic.njk
title: "Floods, Droughts & Cyclones — India's Major Natural Disasters & Response Mechanisms"
...
- **Context:** The concept of flood plain zoning was recommended by the Rashtriya Barh Ayog (National Flood Commission, 1976); "zoning" from English *zone*, from Latin *zōna*, from Greek *zōnē* ("belt, girdle").
- **UPSC Relevance:** GS3 Disaster Management. Mains asks about non-structural flood mitigation measures — flood plain zoning is the primary example alongside flood forecasting and flood insurance. Despite the Model Bill being circulated in 1975, only Manipur and Rajasthan have adopted it — this implementation gap is a critical Mains point. Connect to increasing urban flooding (Bengaluru, Chennai) caused by encroachment on flood plains and the failure of land-use planning.
...
- **Context:** The framework for drought declaration in India is guided by the Manual for Drought Management (2016) issued by the Ministry of Agriculture; "drought" from Old English *drūgaþ* ("dryness") and "declaration" from Latin *dēclārātiō* ("a making clear").
- **UPSC Relevance:** GS3 Disaster Management and GS3 Agriculture. Prelims may test the IMD criteria for drought (25% rainfall deficiency) and the distinction between meteorological, hydrological, and agricultural drought. Mains asks about drought management strategy — linking drought declaration to SDRF/NDRF fund release, crop insurance (PMFBY), and long-term mitigation through watershed management. The Manual for Drought Management 2016 and its multi-indicator approach are important for structured answers.
