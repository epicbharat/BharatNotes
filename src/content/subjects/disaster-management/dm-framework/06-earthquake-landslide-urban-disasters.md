...
- **UPSC Relevance:** GS1 Physical Geography and GS3 Disaster Management. Prelims tests the logarithmic nature (10x amplitude, ~31.6x energy per unit), the distinction between Richter and Moment Magnitude (Mw) scales, and differences between magnitude (energy released) and intensity (damage felt, measured on Modified Mercalli scale). Mains connects to earthquake preparedness, building codes, and why accurate magnitude measurement matters for early warning and response planning.
...
- **Context:** The BIS seismic zonation framework was first established in the 1962 edition of IS 1893; the four-zone system (merging Zone I into Zone II) was adopted in the 2002 revision; the five-zone system was introduced in the 2025 revision based on probabilistic seismic hazard assessment.
- **UPSC Relevance:** GS3 Disaster Management. Prelims tests which zones cover which regions — Zone V (NE India, J&K, Uttarakhand, northern Bihar, Gujarat's Kutch), Zone IV (Delhi, NCR, northern plains), and the 2025 introduction of Zone VI (Super-Critical, entire Himalayan belt). Mains asks about earthquake preparedness in India, enforcement of building codes in seismic zones, and why 59% of India's landmass is vulnerable to earthquakes. The IS 1893:2025 revision adding Zone VI is a significant current affairs development.
