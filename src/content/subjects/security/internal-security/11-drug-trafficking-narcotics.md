---
layout: topic.njk
title: "Drug Trafficking & Narcotics Control — NDPS Act, Golden Triangle & Darknet"
subject: security
...
1. **Enforcement** -- Techno-policing, smart surveillance, drone detection at borders
2. **Education** -- Preventive awareness in schools, colleges, and vulnerable communities
3. **Empathy** -- Medical approach to addiction rather than punitive measures; treating addicts as patients, not criminals
4. **Expansion** -- Upscaling rehabilitation infrastructure to bridge the gap between demand and treatment capacity
