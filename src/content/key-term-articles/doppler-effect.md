---
termSlug: "doppler-effect"
sourceFile: "02-heat-thermodynamics-sound"
layout: false
---
...
| # | Feature | Details |
|---|---------|---------|
| 1 | Definition | Change in observed frequency/wavelength due to relative motion between source and observer |
| 2 | Proposed by | Christian Doppler (1842, Austria) |
| 3 | Applies to | Sound waves, light waves, radio waves — all wave phenomena |
| 4 | Approaching source | Frequency increases, wavelength decreases (wave compression) |
| 5 | Receding source | Frequency decreases, wavelength increases (wave stretching) |
| 6 | Redshift | Light from objects moving away shifts toward longer (red) wavelengths |
| 7 | Blueshift | Light from objects approaching shifts toward shorter (blue) wavelengths |
| 8 | Sonic boom | Occurs when source exceeds speed of sound (Mach > 1); shock wave forms |
| 9 | Doppler radar | Used in meteorology to track storm movement, rainfall velocity, and cyclone intensity |
| 10 | Medical use | Doppler ultrasound measures blood flow velocity in arteries and veins non-invasively |
| 11 | Astronomy use | Measures speed of stars and galaxies; confirmed expanding universe (Hubble, 1929) |
| 12 | Speed cameras | Police radar guns use Doppler shift of reflected microwaves to measure vehicle speed |
